...
| Production deployment | `docker/compose.deploy.yml` and `docker/DEPLOYMENT.md` | Use the complete repository; the guide owns environment, proxy, PaaS, backup, and recovery procedures |
