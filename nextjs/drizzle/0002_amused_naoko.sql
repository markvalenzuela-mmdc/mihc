ALTER TABLE "apps" DROP CONSTRAINT "apps_created_by_user_id_fk";--> statement-breakpoint
ALTER TABLE "apps" DROP CONSTRAINT "apps_updated_by_user_id_fk";--> statement-breakpoint
ALTER TABLE "smoke_runs" DROP CONSTRAINT "smoke_runs_started_by_user_id_fk";--> statement-breakpoint
...
ALTER TABLE "e2e_runs" DROP CONSTRAINT "e2e_runs_started_by_user_id_fk";--> statement-breakpoint
ALTER TABLE "profiles" DROP CONSTRAINT "profiles_created_by_user_id_fk";--> statement-breakpoint
ALTER TABLE "profiles" DROP CONSTRAINT "profiles_updated_by_user_id_fk";--> statement-breakpoint
ALTER TABLE "apps" ALTER COLUMN "created_by" SET DATA TYPE uuid USING "created_by"::uuid;--> statement-breakpoint
ALTER TABLE "apps" ALTER COLUMN "updated_by" SET DATA TYPE uuid USING "updated_by"::uuid;--> statement-breakpoint
ALTER TABLE "smoke_runs" ALTER COLUMN "started_by" SET DATA TYPE uuid USING "started_by"::uuid;--> statement-breakpoint
...
ALTER TABLE "e2e_runs" ALTER COLUMN "started_by" SET DATA TYPE uuid USING "started_by"::uuid;--> statement-breakpoint
ALTER TABLE "profiles" ALTER COLUMN "created_by" SET DATA TYPE uuid USING "created_by"::uuid;--> statement-breakpoint
ALTER TABLE "profiles" ALTER COLUMN "updated_by" SET DATA TYPE uuid USING "updated_by"::uuid;--> statement-breakpoint
