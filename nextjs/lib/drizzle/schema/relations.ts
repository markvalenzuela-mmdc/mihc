...
export const e2eRunStepsRelations = relations(e2eRunSteps, ({ one, many }) => ({
  e2eRun: one(e2eRuns, { fields: [e2eRunSteps.runId], references: [e2eRuns.id] }),
  e2eStep: one(e2eSteps, { fields: [e2eRunSteps.stepId], references: [e2eSteps.id] }),
  tests: many(e2eRunTests),
}));

export const e2eRunTestsRelations = relations(e2eRunTests, ({ one }) => ({
  runStep: one(e2eRunSteps, { fields: [e2eRunTests.runStepId], references: [e2eRunSteps.id] }),
}));
