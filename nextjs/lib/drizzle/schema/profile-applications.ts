...
export const profileEnrollmentData = pgTable(
  "profile_enrollment_data",
  {
    ...
    // Legacy flow-specific columns retained for data-preserving migration.
    gender: text("gender"),
    ...
    isLeapPadReEnrollment: boolean("is_leap_pad_re_enrollment")
      .notNull()
      .default(false),
    ...
    copyPermanentGuardianAddress: boolean(
      "copy_permanent_guardian_address",
    ).default(false),
    ...auditColumns,
  },
  (table) => [
