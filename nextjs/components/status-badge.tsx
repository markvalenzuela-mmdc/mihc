...
const statusConfig = {
  ...
  new: { icon: CircleDashedIcon, className: "border-slate-500/30 bg-slate-500/10 text-slate-300" },
  guidance_needed: { icon: Clock3Icon, className: "border-amber-500/30 bg-amber-500/10 text-amber-200" },
  validated: { icon: CheckCircle2Icon, className: "border-emerald-500/30 bg-emerald-500/10 text-emerald-300" },
  verification: { icon: TriangleAlertIcon, className: "border-blue-500/30 bg-blue-500/10 text-blue-300" },
  enrollment_confirmation: { icon: CircleDotDashedIcon, className: "border-purple-500/30 bg-purple-500/10 text-purple-300" },
  for_payment: { icon: CircleDotDashedIcon, className: "border-amber-500/30 bg-amber-500/10 text-amber-200" },
  payment_verification: { icon: TriangleAlertIcon, className: "border-orange-500/30 bg-orange-500/10 text-orange-300" },
